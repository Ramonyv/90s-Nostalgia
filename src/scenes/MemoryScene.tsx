...
export function MemoryScene({ scene, videoSoundEnabled }: { scene: Scene; videoSoundEnabled: boolean }) {
  ...
  useEffect(() => {
    ...
    if (videoSoundEnabled) void video.play().catch(() => { video.muted = true })
  }, [scene.id, showVideo, videoSoundEnabled])
