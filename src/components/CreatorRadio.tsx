...
export function CreatorRadio() {
  return <motion.aside className="creator-radio" initial={{ opacity: 0, x: 12 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: .55, delay: .35, ease: [0.22, 1, 0.36, 1] }} aria-label="About the creator">
