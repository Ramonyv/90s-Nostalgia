...
export const scenes: Scene[] = [
  {
    ...
    hotspots: [
      { x: 78, y: 37, label: 'Turn on the salon radio.', align: 'right', action: 'spotify' },
  ...
  },
  {
    ...
    description: 'पर जल्दी किसी को नहीं थी।', background: '/scenes/truck.webp', mobileBackground: '/scenes/truck-mobile.webp', mobilePosition: '64% center', accent: '#dda12e', year: '1997', ambience: 'road',
    hotspots: [
  ...
  },
  {
    ...
    description: 'पर इंतज़ार अच्छा लगता था।', background: '/scenes/railway.webp', mobileBackground: '/scenes/railway-mobile.webp', mobilePosition: '62% center', accent: '#62839a', year: '1995', ambience: 'station',
    hotspots: [
